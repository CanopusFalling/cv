...
<Timeline>
  ...
  >
    As part of a team at The University of Sheffield, we designed requirements for a software system with a client. We then worked to deliver the client a piece of software within the alloted timeframe making sure to deliver key requirements.
  ...
  >
    ...
    <ChipContainer>
      <Chip>Educational Content Design</Chip>
      <Chip>Presentation Skills</Chip>
      <Chip>Adaptability in Teaching</Chip>
      <Chip>Project Management</Chip>
      <Chip>Performance Reporting</Chip>
    </ChipContainer>
  ...
  >
    Working alongside a team of volunteers, I actively participated in the development of a centralized website dedicated to LGBTQ+ events in Sheffield. This experience greatly contributed to my skillset in coordinating voluntary initiatives and establishing valuable collaborations with local organizations within the city.

    #### Skills

    <ChipContainer>
      <Chip>Digital Accessibility</Chip>
      <Chip>NextJS</Chip>
...
<ChipContainer>
  ...
  <Chip>Presentation Delivery</Chip>
  <Chip>Digital Accessibility</Chip>
  <Chip>Data Protection</Chip>
  <Chip>Performance Monitoring</Chip>
  <Chip>Productivity Optimisation</Chip>
  <Chip>Office Software Proficiency</Chip>
</ChipContainer>
